...
## 12.1.2.10 / 11.1.1.16 (2026-09-22)

- 🧪[测试]-新增 `net8.0` xUnit 回归测试，覆盖自然排序数字段、嵌套属性、空值和缺失属性路径。

## 12.1.2.9 / 11.1.1.15 (2026-09-22)

- 🛠️[优化]-两个 Demo 启用 Avalonia 编译绑定并声明视图模型类型，降低 NativeAOT 对运行时反射绑定的依赖。
